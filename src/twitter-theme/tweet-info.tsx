...
export const TweetInfo = (props: { tweet: EnrichedTweet }) => (
  <div class="tweet-s-info">
    <TweetInfoCreatedAt tweet={props.tweet} />
    <a
      class="tweet-s-info-link"
    ...
    >
      <svg viewBox="0 0 24 24" aria-hidden="true" class="tweet-s-info-icon">
        <g>
